@ echo off & echo  & Mode 82,18 & color E0 & Title SumatraPDF-Addin 2-Up-PDF v'21-03-17--04
SetLocal EnableDelayedExpansion & goto MAIN

 Cpdf Alternative 2-UP version using cpdf -twoup in.pdf -o out.pdf 
...
echo: & start "" "%~dp0..\..\SumatraPDF.exe" -reuse-instance -view facing "%~dpn1-2-Up.pdf"
